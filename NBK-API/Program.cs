...
using System.Text;
  // Ensure this namespace is correct and points to where your ApplicationDbContext is defined.
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    var filePath = Path.Combine(AppContext.BaseDirectory, "NBKController.cs");
